...
import {Card, CardGrid, CellButton, Group, Header, Headline, Panel, PanelHeader, Spacing, Text} from "@vkontakte/vkui";
    ...
    return (
        <Panel>
            ...
            <Group className={styles.group} header={<Header>Бронирования</Header>}>
                ...
                <CellButton before={<Icon28AddOutline/>} onClick={() => setPanel('form')}>Добавить бронь</CellButton>
            </Group>
        </Panel>
    )
}
